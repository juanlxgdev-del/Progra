...
class Usuario(Persona):
    ...
    def hacer_reserva(self, func, cant_asientos):
        ...
        if not asientos_que_le_toco:
            return None
        precio_total = func.precio * cant_asientos
        res = Reserva(len(self.historial_reservas) + 1, self, func, asientos_que_le_toco, precio_total)
